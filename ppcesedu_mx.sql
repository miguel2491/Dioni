...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-06-2020 a las 02:49:19
...
(6, 'Recision', 'administracion1.png');
...
(3, 9, 'Miguel', 'Miguel  ', 'mike@mail.com');
...
INSERT INTO `materias` (`id`, `nombre`, `id_cuatrimestre`, `id_carrera`, `id_maestro`) VALUES
(1, 'DERECHO I', 1, 1, 3),
(2, 'DERECHO II', 1, 1, 0),
(3, 'LEYES I', 1, 1, 0),
(4, 'LEYES II', 1, 1, 0),
...
(9, 'Miguel', 'mike@mail.com', '$2y$10$6rBoLWzKGa6nJ0Oiv.LxXea2Wbkwu64MjG/8Cfvya6CCRf9U4dEue', NULL, NULL, NULL);
...
--
ALTER TABLE `role_user`
  MODIFY `idRolUser` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
