...
<input type="hidden" id="url_listado" value="{{ url('clases/lista') }}">
<input type="hidden" id="url_datosget" value="{{ url('clases/datos') }}">
...
@section('main-scripts')
	...
	<script src="{{ asset('js/catalogos/clases.js') }}"></script>
@endsection