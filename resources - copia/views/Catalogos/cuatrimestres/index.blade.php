...
<input type="hidden" id="url_listado" value="{{ url('cuatrimestres/lista') }}">
<input type="hidden" id="url_datosget" value="{{ url('cuatrimestres/datos') }}">
<input type="hidden" id="url_guardar" value="{{ url('cuatrimestres/guardar') }}">
<input type="hidden" id="url_actualizar" value="{{ url('cuatrimestres/update') }}">
<input type="hidden" id="url_eliminar" value="{{ url('cuatrimestres/delete') }}">
		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<div class="row">
						<div class="col-md-7">
							<h5><i class="glyphicon glyphicon-align-justify"></i> Cuatrimestres</h5>
						</div>
						<div class="col-md-5">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="ModalEditar">Cuatrimestre</h4>
			</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" autofocus="true" id="cuatrimestre" name="cuatrimestre" class="form-control" >
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
...
@section('main-scripts')
	...
	<script src="{{ asset('js/catalogos/cuatrimestres.js') }}"></script>
@endsection
